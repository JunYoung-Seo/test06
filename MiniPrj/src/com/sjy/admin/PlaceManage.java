			...
			while (!wh2) {
				...
				case 1: {
					...
					if (fc == 0) {
						...
						System.out.print("맛집 추가: ");
						String updfc = Utill.scString();
						// 맛집추가
						// Insert
						...
						// 수정 내용 Update
						System.out.print("수정할 맛집 입력:");
						String updfc = Utill.scString();
						System.out.println("추가완료");
						continue;
					} else if (fc == 4) {
						System.out.println("---------------삭제---------------");
						System.out.print("삭제할 맛집 입력:");
						String updfc = Utill.scString();
						// 입력받은 맛집 delete
